...
description: How solo-dev onboards an existing codebase — Foundation Mode, Standard Onboarding, and how to continue WIP features.
---
...
See [Configuration](/docs/guides/configuration) for foundation settings.
