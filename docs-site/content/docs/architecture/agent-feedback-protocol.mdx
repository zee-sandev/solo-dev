---
title: Agent Feedback Protocol
description: 3 levels of structured feedback between agents — contract validation, quality feedback, and strategic feedback.
---
...
| `PERSONA_REJECTION` | persona-validator → research | Spec rejected — severity: `REJECT_BLOCKING` or `REJECT_DEGRADED` |
